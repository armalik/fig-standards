...
[PSR-0]: https://github.com/armalik/fig-standards/blob/v1/accepted/PSR-0.md
[PSR-1]: https://github.com/armalik/fig-standards/blob/v1/accepted/PSR-1-basic-coding-standard.md
...
Code MUST use tabs for indenting, and not spaces.
